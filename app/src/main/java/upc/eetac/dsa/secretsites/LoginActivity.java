...
public class LoginActivity extends AppCompatActivity {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                this.user = client.login(mUsername, mPassword);
                return null;
            }
        ...
        protected void onPostExecute(final String response) {
            ...
            if(this.user != null) {                        //Is credentials OK
                Intent returnIntent = new Intent();
                returnIntent.putExtra("user", this.user);
                setResult(Activity.RESULT_OK, returnIntent);
                finish();
            }
            else if(response.contains("username")) {          //Wrong Username
                mUsernameView.setError(getString(R.string.error_incorrect_username));
                mUsernameView.requestFocus();
            }
            else if(response.contains("password")) {          //Wrong Password
